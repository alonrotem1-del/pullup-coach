...
(function (root, factory) {
  ...
  var EXERCISES = {
    pullup: { id: 'pullup', name: 'Pull-Up', category: 'pull', measure: 'reps',
      cues: 'Full range — from straight arms to chin above bar.', related: ['mu_pull1', 'mu_pull5', 'mu_pull10'] },
    scap: { id: 'scap', name: 'Scapular Pull-Up', category: 'pull', measure: 'reps',
      cues: 'Straight arms, pull shoulders down and back.', related: ['mu_scap'] },
    deadhang: { id: 'deadhang', name: 'Active Hang', category: 'grip', measure: 'seconds',
      cues: 'Active shoulders, not hanging passively.', related: ['mu_deadhang', 'b_activehang'] },
    fastpull: { id: 'fastpull', name: 'Explosive Pull-Up', category: 'pull', measure: 'reps',
      cues: 'Maximum acceleration upward, controlled descent.', related: ['mu_fastpull'] },
    c2b: { id: 'c2b', name: 'Chest-to-Bar', category: 'pull', measure: 'reps',
      cues: 'Pull until chest touches the bar.', related: ['mu_c2b'] },
    support: { id: 'support', name: 'Support Hold', category: 'push', measure: 'seconds',
      cues: 'Straight locked arms above the bar, tight body.', related: ['mu_support'] },
    dip: { id: 'dip', name: 'Straight-Bar Dip', category: 'push', measure: 'reps',
      cues: 'Controlled descent, full lockout on top.', related: ['mu_dip5'] },
    hollow: { id: 'hollow', name: 'Hollow Body', category: 'core', measure: 'seconds',
      cues: 'Lower back pressed to floor, pelvis slightly tucked.', related: ['mu_hollow'] },
    lowtrans: { id: 'lowtrans', name: 'Low-Bar Transition', category: 'skill', measure: 'reps',
      cues: 'Get wrists over the bar quickly, no "chicken wing."', related: ['mu_lowtrans'] },
    negmu: { id: 'negmu', name: 'Negative Muscle-Up', category: 'skill', measure: 'reps',
      cues: 'Slow descent through the transition, control full range.', related: ['mu_negmu'] },
    bandmu: { id: 'bandmu', name: 'Banded Muscle-Up', category: 'skill', measure: 'reps',
      cues: 'Band for minimal assistance, maintain a clean path.', related: ['mu_bandmu'] },
    activehang: { id: 'activehang', name: 'Active Hang', category: 'grip', measure: 'seconds',
      cues: 'Active and engaged shoulders.', related: ['b_activehang'] },
    lockoff: { id: 'lockoff', name: 'Lock-Off', category: 'pull', measure: 'seconds',
      cues: 'Hold at a stable bent-arm angle.', related: ['b_lockoff'] }
  };
